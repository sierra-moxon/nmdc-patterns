...
# Generation date: 2024-04-16T16:29:37
...
slots.primary_email = Slot(uri=SCHEMA.email, name="primary_email", curie=SCHEMA.curie('email'),
                   model_uri=NMDC_PATTERNS.primary_email, domain=None, range=Optional[str])

slots.birth_date = Slot(uri=SCHEMA.birthDate, name="birth_date", curie=SCHEMA.curie('birthDate'),
                   model_uri=NMDC_PATTERNS.birth_date, domain=None, range=Optional[Union[str, XSDDate]])

slots.age_in_years = Slot(uri=NMDC_PATTERNS.age_in_years, name="age_in_years", curie=NMDC_PATTERNS.curie('age_in_years'),
                   model_uri=NMDC_PATTERNS.age_in_years, domain=None, range=Optional[int])

slots.vital_status = Slot(uri=NMDC_PATTERNS.vital_status, name="vital_status", curie=NMDC_PATTERNS.curie('vital_status'),
                   model_uri=NMDC_PATTERNS.vital_status, domain=None, range=Optional[Union[str, "PersonStatus"]])
...
slots.Activity_primary_email = Slot(uri=SCHEMA.email, name="Activity_primary_email", curie=SCHEMA.curie('email'),
                   model_uri=NMDC_PATTERNS.Activity_primary_email, domain=Activity, range=Optional[str],
